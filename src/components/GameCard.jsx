...
export default function GameCard({ game }) {
  ...
  return (
    <div key={game.id} className=" nearblack rounded-lg shadow-lg shadow-amber-900 overflow-hidden transform md:hover:scale-105 transition-transform duration-300 ease-in-out  flex flex-col h-full">
      ...
      <div className="p-4 pb-12 flex-grow relative">
        <div className=" flex justify-between items-baseline" > <h3 className="text-xl font-semibold mb-2 text-white truncate">{game.name}</h3><FavoriteButton  game={game} /></div>
