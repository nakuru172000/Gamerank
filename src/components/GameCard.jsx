...
export default function GameCard({ game }) {
  ...
  return (
  <div key={game.id} className="bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer flex flex-col h-full">
  {/* Image */}
  ...
  <div className="p-4 pb-12 flex-grow relative"> {/* Increased bottom padding */}
    ...
    <div className="absolute bottom-4 left-4"> {/* Matches the card padding */}
      <Link 
        ...
        className="
          relative px-3 py-1 rounded-lg font-medium text-white
          bg-purple-600 hover:bg-purple-700 
          border-b-4 border-purple-400 hover:border-purple-300
